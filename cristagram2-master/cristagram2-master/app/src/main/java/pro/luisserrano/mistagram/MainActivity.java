...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent!=null) {
            ...
            //TODO(1): COMPLETED Escribir en las preferencias "PREFS" el par con clave "profileid" y con valor publisher
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                   ...
                   switch ( item.getItemId()){
                        ...
                        case R.id.nav_profile:
                            ...
                            //TODO(2): COMPLETED Escribir en las preferencias "PREFS" el par con clave "profileid" y con valor el Uid del usuario de Firebase
                            SharedPreferences prefs = getSharedPreferences("PREFS", Context.MODE_PRIVATE);
                    ...
                    //TODO(3): COMPLETED Si selectedFragment no es null entonces mostrar el dicho fragment en R.id.fragment_container
