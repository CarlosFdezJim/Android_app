...
public class StoryActivity extends AppCompatActivity implements StoriesProgressView.StoriesListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r_seen.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( pro.luisserrano.mistagram.StoryActivity.this, FollowersActivity.class );
                ...
                reference.removeValue().addOnCompleteListener( new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            Toast.makeText( pro.luisserrano.mistagram.StoryActivity.this,"Deleted!",Toast.LENGTH_SHORT ).show();
                            finish();
                        }
                    }
                } );
    ...
    private void getStories(String userid){
        ...
        reference.addListenerForSingleValueEvent( new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                storiesProgressView.setStoriesListener( pro.luisserrano.mistagram.StoryActivity.this );
    ...
    private void seenNumber(String storyid){
        ...
        //TODO(33): COMPLETED Inicializar reference a /Story/iddelusuario/iddelstory/views
        reference.addListenerForSingleValueEvent( new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
