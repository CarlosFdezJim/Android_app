...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //TODO(8): COMPLETED inicializar auth a la instancia de FirebaseAuth
        auth = FirebaseAuth.getInstance();
        //TODO(9): COMPLETED colocar un listener a txtLogin de modo que lance LoginActivity si hace click
        ...
        binding.register.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //TODO(10): COMPLETED Hacer los correspondientes if-else para que se puedan mostrar los siguientes toasts correctamente
                if((str_username == null) || (str_email == null) || (str_fullname == null) || (str_password == null) ){
