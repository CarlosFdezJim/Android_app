...
public class MovieActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //binding.rvRecommendSeries.setAdapter(movieAdapter); MUEVO ABAJO
        ...
        //binding.rvCasting.setAdapter(similarAdapter); MUEVO ABAJO

        //Agregado el casting y añadiendo el adaptador
    ...
    public void bindMovie(final MovieDetail movie){
        ...
        binding.btWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //TODO(2) COMPLETE: Abrir el trailer en Youtube
                if(trailer != null) {
        ...
        call.enqueue(new Callback<MovieDetail>() {
            ...
            public void onResponse(Call<MovieDetail> call, Response<MovieDetail> response) {
                switch (response.code()) {
                    case 200:
                        //TODO(3)COMPLETED : Mostrar la búsqueda
            ...
            public void onResponse(Call<CreditsFeed> call, Response<CreditsFeed> response) {
                switch (response.code()) {
                    case 200:
                        ...
                        //TODO(4) COMPLETED: Mostrar el casting
    ...
    public void loadSimilarMovies(){
        ...
        int idReal = (int) id;
        MovieService getMovie = RetrofitInstance.getRetrofitInstance().create(MovieService.class);
        /* Se definen los parámetros de la llamada a la función getSimilarMovies */
