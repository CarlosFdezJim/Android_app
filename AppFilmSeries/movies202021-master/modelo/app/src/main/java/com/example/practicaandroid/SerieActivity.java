...
public class SerieActivity extends AppCompatActivity {
    ...
    private void loadCast() {
        ...
        call.enqueue(new Callback<CreditsFeed>() {
            ...
            public void onResponse(Call<CreditsFeed> call, Response<CreditsFeed> response) {
                switch (response.code()) {
                    case 200:
                        //TODO(5) COMPLETE: Cargar Casting
    ...
    public void loadSimilarSeries() {
        ...
        int idReal = (int) id;
        //TODO(6) COMPLETED: Crear objeto retrofit y llamar a conseguir las series similares
        MovieService getMovie = RetrofitInstance.getRetrofitInstance().create(MovieService.class);
        /* Se definen los parámetros de la llamada a la función getSimilarSeries */
        Call<TVShowFeed> call = getMovie.getSimilarSeries(idReal, RetrofitInstance.getApiKey(), "es");
